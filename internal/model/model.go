...
type Camera struct {
	...
	// DetectionEnabled keeps the historical JSON name for compatibility, but
	// now controls only the camera's native ONVIF event subscription.
...
func (c Camera) Public() CameraPublic {
	return CameraPublic{
		...
		DetectionEnabled: c.DetectionEnabled, CreatedAt: c.CreatedAt, UpdatedAt: c.UpdatedAt,
	}
}
...
type DetectionEvent struct {
	...
	ONVIFTopic            string    `json:"onvif_topic,omitempty"`
